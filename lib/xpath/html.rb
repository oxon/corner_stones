# This class was removed from XPath. In order to make this gem still do something without major refactoring, it needs to be around.
# see https://github.com/teamcapybara/xpath/pull/80/files
